...
const Upcoming = () => {
    ...
    const [param, setParam] = useState({'orderStatus': 'DISPATCH'});
    ...
    // const fetchDataApi = async(refresh) => {
    //     const data = await authApi.staffOperation(page);
    ...
    //             setOrder([...order, ...data.data.results]);
    //         if(data.data['next'])
    //             setpage(getNext(data.data['next']))
    //         else
    //             setpage(null);
    //         return true
    //     }
    ...
    //         setLoading(true); 
    //     }
    //     const result = fetchDataApi(refresh);
    // }
    // const handleOnEndReached = async() => {
    //     if(page !== null){
    //         setLoadMore(true)
    //         const result = fetchDataApi()
    //         if(data.ok){
